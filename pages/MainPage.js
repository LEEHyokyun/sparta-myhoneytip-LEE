...
import main from '../assets/test_main.png';
//Platform import 추가!!
  ...
  return ready ? <Loading/> :  (
    ...
    */
    <ScrollView style={styles.container}>
        ...
        {/*가로배너를 맨 하단에 배치하기위해, View 태그로 가로배너 문법을 시작, 선언한다*/}
        <View style={styles.cardContainer}>
            ...
            {/*애드몹 광고를 사용하기 위한 자바스크립트 문법*/}
            {/*'react-native에 Platform import*/}
            {/*삼항연산자, 아이폰으로 실행시 전문, 안드로이드 실행시 후문을 실행한다.*/}
            {/*광고단위를 만들고 받은 "가로배너"에 대한 key값을 적용한다!!*/}
            {Platform.OS === 'ios' ? (
                <AdMobBanner
                  bannerSize="fullBanner"
                  servePersonalizedAds={true}
                  //아래 key값은 구글 애드몹에서 받는것
                  adUnitID="ca-app-pub-2521868996473895/6891563405"
                  style={styles.banner}
                />
            ) : (
                <AdMobBanner
                  bannerSize="fullBanner"
                  servePersonalizedAds={true}
                  adUnitID="ca-app-pub-2521868996473895/8444495832"
                  style={styles.banner}
                />
            )}
        </View>
